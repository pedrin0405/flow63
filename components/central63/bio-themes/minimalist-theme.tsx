        ...
        <div className={cn(
          ...
          <div className={cn(!isPreview && "lg:sticky lg:top-16")}>
            ...
            <motion.div 
              ...
              className={cn(
                "relative w-full rounded-[3rem] overflow-hidden transition-all",
                isPreview ? "p-6" : "p-10"
              )}
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ delay: 0.1 }}>
                  <img 
                    ...
                    alt={data.nome}
                    className={cn(
                      "mx-auto rounded-full object-cover p-1",
                      isPreview ? "w-20 h-20" : "w-32 h-32"
                    )}
                    style={{ 
                      border: `1px solid ${tema.text_color}20`,
                      objectPosition: tema.foto_posicao || "center"
                    }}
                  />
                </motion.div>

                <h2 className="mt-8 text-[11px] font-bold uppercase tracking-[4px] opacity-60" style={{ color: tema.text_color }}>
                  {data.headline || "Corretor Imobiliário"}
                </h2>

                <h1 className={cn(
                  "mt-3 mb-4 font-bold leading-[1.1] tracking-tight",
                  isPreview ? "text-[24px]" : "text-4xl"
              ...
              <div className="hidden lg:flex flex-wrap items-center justify-center gap-4 mt-8 px-4">
                {socialLinks.map((link: any, index: number) => (
                  <a 
                    ...
                    style={{ ...minimalCardStyle(tema), color: tema.text_color }}
                  >
