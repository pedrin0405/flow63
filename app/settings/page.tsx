...
import { UserPlus, Save, Camera, Loader2, RefreshCw, AlertTriangle } from "lucide-react"
        ...
        <div className="p-8 max-w-6xl mx-auto space-y-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Gira a sua conta e as permissões da equipa.</p>
            </div>
