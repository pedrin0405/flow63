...
import {
  ...
  CornerUpLeft, CornerUpRight, CornerDownLeft, CornerDownRight, Loader2, Plus, Share, Send
} from 'lucide-react';
    ...
    <div className="flex h-screen w-full flex-col bg-slate-100 overflow-hidden">
      ...
      <header className="h-14 border-b bg-white flex items-center justify-between px-6 shrink-0 z-20">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" className="hover:bg-blue-50 rounded-full text-blue-950" onClick={() => router.back()}>
        ...
        <aside className="w-[380px] bg-white border-r flex flex-col overflow-hidden shrink-0">
          <Tabs defaultValue="projetos" className="flex flex-row w-full h-full">
            ...
            <TabsList className="flex flex-col h-full w-[80px] shrink-0 bg-gradient-to-b from-blue-600 to-indigo-600 text-white justify-start py-4 gap-3 rounded-none h-auto border-none">
              ...
              {/* As classes principais que mantêm branco são: text-white data-[state=active]:text-white */}
